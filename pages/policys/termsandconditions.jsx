...
function termsandconditions() {
  return (
    <div style={{margin:"20px"}}>
      ...
      <p>Welcome to kalyaniammas!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of vihara life care pvt.ltd's Website, located at www.klayaniammas.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use kalyaniammas if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing kalyaniammas, you agreed to
        use cookies in agreement with the vihara life care pvt.ltd's Privacy
        Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, vihara life care pvt.ltd and/or its licensors
        own the intellectual property rights for all material on kalyaniammas.
        All intellectual property rights are reserved. You may access this from
        kalyaniammas for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from kalyaniammas</li>
        <li>Sell, rent or sub-license material from kalyaniammas</li>
        <li>Reproduce, duplicate or copy material from kalyaniammas</li>
        <li>Redistribute content from kalyaniammas</li>
      </ul>
      ...
      <p>
        ...
        vihara life care pvt.ltd does not filter, edit, publish or review
        Comments prior to their presence on the website. Comments do not reflect
        the views and opinions of vihara life care pvt.ltd,its agents and/or
        ...
        laws, vihara life care pvt.ltd shall not be liable for the Comments or
      ...
      <p>
        vihara life care pvt.ltd reserves the right to monitor all Comments and
      ...
      <p>
        You hereby grant vihara life care pvt.ltd a non-exclusive license to
      ...
      <p>
        ...
        the hyperlink compensates the absence of vihara life care pvt.ltd; and
      ...
      <p>
        ...
        e-mail to vihara life care pvt.ltd. Please include your name, your
      ...
      <p>
        No use of vihara life care pvt.ltd's logo or other artwork will be
