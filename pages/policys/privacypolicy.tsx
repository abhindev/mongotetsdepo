      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to vihara life care private limited, GROUND
            FLOOR, VP 19 86/A, VARNALAYA BUILDING, VARAMBATTA, Wayanad.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to kalyaniammas, accessible from{" "}
            <a
              href="www.kalyaniammas.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              www.kalyaniammas.com
            </a>
          </p>
        </li>
        <li>
